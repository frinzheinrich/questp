...
from japanerrorprocess import japanep
from kerrorp import koreanep
from id import *
...
def crosscheck():
    ...
    crosscheck_files = request.files.getlist('fileInput[]')  # These are the files from the cross-check button
