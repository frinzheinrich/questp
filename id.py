...
'''local_file_path = "C:/Users/estra/Downloads/testpassport.png"

# Analyze the ID
result = analyze_local_id(local_file_path)

# Print results
if isinstance(result, dict):
    print("ID Analysis Results:")
    for field_type, value in result.items():
